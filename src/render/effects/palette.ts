...
export function applyPalette(ctx: CanvasRenderingContext2D, p: VibeConfig['palette']) {
...
export function tintOverlay(ctx: CanvasRenderingContext2D, w: number, h: number, p: VibeConfig['palette']) {
